...
Assume a power law, how does that exponent change by year?
...
#  dplyr::filter(mag >= 1, yr == i | yr == i-1 | yr == i-2 | yr == i-3 | yr == i-4) |>
...
w.df <- data.frame(Year = 1954:2020, w)

ggplot(data = w.df,
       mapping = aes(x = Year, y = w)) +
#  scale_y_continuous(limits = c(1, 2)) +
  scale_x_continuous(breaks = seq(1955, 2020, by = 15)) +
  geom_point() +
  geom_quantile()
